...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(MainWindow)
        ...
        self.tableWidget_packets = QtWidgets.QTableWidget(parent=self.widget)
        self.tableWidget_packets.setObjectName("tableWidget_packets")
        self.tableWidget_packets.setColumnCount(2)
        self.tableWidget_packets.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_packets.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_packets.setHorizontalHeaderItem(1, item)
        self.verticalLayout_4.addWidget(self.tableWidget_packets)
        ...
        self.textEdit_cmd = QtWidgets.QTextEdit(parent=self.groupBox)
        self.textEdit_cmd.setReadOnly(True)
        self.textEdit_cmd.setObjectName("textEdit_cmd")
        self.gridLayout_2.addWidget(self.textEdit_cmd, 0, 0, 1, 1)
        self.verticalLayout_3.addWidget(self.groupBox)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.plainTextEdit_CMD = QtWidgets.QPlainTextEdit(parent=self.widget)
        self.plainTextEdit_CMD.setObjectName("plainTextEdit_CMD")
        self.horizontalLayout_12.addWidget(self.plainTextEdit_CMD)
        self.pushButton_parser = QtWidgets.QPushButton(parent=self.widget)
        self.pushButton_parser.setObjectName("pushButton_parser")
        self.horizontalLayout_12.addWidget(self.pushButton_parser)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "UCI Tool"))
        self.label.setText(_translate("MainWindow", "Message Type : "))
        self.comboBox_msgType.setItemText(0, _translate("MainWindow", "Data Packet"))
        self.comboBox_msgType.setItemText(1, _translate("MainWindow", "Command Message"))
        self.comboBox_msgType.setItemText(2, _translate("MainWindow", "Response Message"))
        self.comboBox_msgType.setItemText(3, _translate("MainWindow", "Notification Message"))
        self.label_2.setText(_translate("MainWindow", "PBF : "))
        self.comboBox_PBF.setItemText(0, _translate("MainWindow", "0b0 Complete"))
        self.comboBox_PBF.setItemText(1, _translate("MainWindow", "0b1 Segement"))
        self.label_4.setText(_translate("MainWindow", "DPF : "))
        self.comboBox_DPF.setItemText(0, _translate("MainWindow", "DATA_MESSAGE_SND"))
        self.comboBox_DPF.setItemText(1, _translate("MainWindow", "DATA_MESSAGE_RCV"))
        self.comboBox_DPF.setItemText(2, _translate("MainWindow", "LL_DATA_MESSAGE_SND"))
        self.comboBox_DPF.setItemText(3, _translate("MainWindow", "LL_DATA_MESSAGE_RCV"))
        self.label_3.setText(_translate("MainWindow", "GID : "))
        self.comboBox_GID.setItemText(0, _translate("MainWindow", "UCI Core"))
        self.comboBox_GID.setItemText(1, _translate("MainWindow", "UWB Session Config"))
        self.comboBox_GID.setItemText(2, _translate("MainWindow", "UWB Session Control"))
        self.comboBox_GID.setItemText(3, _translate("MainWindow", "Vendor Specific 1"))
        self.comboBox_GID.setItemText(4, _translate("MainWindow", "Test Group"))
        self.comboBox_GID.setItemText(5, _translate("MainWindow", "Vendor Specific 2"))
        self.label_5.setText(_translate("MainWindow", "OID : "))
        self.groupBox_payload.setTitle(_translate("MainWindow", "Payload"))
        item = self.tableWidget_payload.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Payload Field"))
        ...
        self.pushButton_delet.setText(_translate("MainWindow", "删除"))
        item = self.tableWidget_packets.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Name"))
        item = self.tableWidget_packets.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Value"))
        self.pushButton_save.setText(_translate("MainWindow", "保存"))
        self.pushButton_edit.setText(_translate("MainWindow", "编辑"))
        self.pushButton_deleteMsg.setText(_translate("MainWindow", "删除"))
        self.pushButton_export.setText(_translate("MainWindow", "导出"))
        self.groupBox.setTitle(_translate("MainWindow", "解析命令"))
        self.pushButton_parser.setText(_translate("MainWindow", "解析"))
